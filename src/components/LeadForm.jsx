      ...
      <div className={`lf lf--success ${dark ? 'lf--dark' : ''}`}>
        <div className="lf__ok-icon">
          <svg width="52" height="52" viewBox="0 0 52 52" fill="none">
            ...
            <path d="M16 26l8 8 13-16" stroke="var(--gold-dark)" strokeWidth="2.8" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </div>
        <h3>¡Solicitud recibida!</h3>
        <p>Gracias, <strong>{form.name}</strong>. Te contactaremos en menos de 24 h con tu diagnóstico personalizado.</p>
        <div className="lf__ok-contacts">
          ...
          <a href="https://wa.me/51921590084" target="_blank" rel="noopener noreferrer" className="lf__ok-btn lf__ok-btn--wa">
