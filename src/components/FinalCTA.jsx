...
export default function FinalCTA() {
  return (
    <section className="fcta section--dark">
      <div className="fcta__glow fcta__glow--1" aria-hidden="true" />
      <div className="fcta__glow fcta__glow--2" aria-hidden="true" />

      <div className="container fcta__inner">
        <div className="fcta__content reveal">
          <div className="badge badge--dark">Diagnóstico gratuito</div>
          <h2 className="fcta__title">
            Empieza a captar más clientes con una web diseñada para vender
          </h2>
          <p className="fcta__desc">
            Solicita tu diagnóstico gratuito. Sin compromiso, sin tecnicismos.
            Solo claridad sobre qué necesita tu negocio para que tu web
            convierta de verdad.
          </p>
          ...
          <div className="fcta__guarantee">
            <div className="fcta__guarantee-icon">
              ...
              >
                <path
                  d="M14 2L4 6v8c0 6.627 4.477 12.535 10 14 5.523-1.465 10-7.373 10-14V6L14 2z"
            ...
            <div>
              ...
              <p className="fcta__guarantee-text">
                Si en 30 días tu web no recibe leads, la revisamos y ajustamos
                sin coste adicional.
              </p>
            </div>
          </div>
          ...
          <div className="fcta__contacts">
            <p className="fcta__contacts-label">
              ¿Prefieres contactar directamente?
            </p>
            <div className="fcta__contacts-links">
              <a
                href="mailto:contacto@flanovax.com"
                className="fcta__contact-btn"
              >
                <svg
                  width="14"
                  height="14"
              ...
              <a
                ...
                className="fcta__contact-btn fcta__contact-btn--wa"
              >
                <svg
                  width="14"
                  height="14"
        ...
        <div className="fcta__form reveal reveal--d2">
          <LeadForm dark />
        </div>
      </div>
    </section>
