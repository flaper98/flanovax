    ...
    <footer className="footer">
      ...
      <div className="container">
        <div className="footer__top">
          <div className="footer__brand">
            ...
            <p className="footer__tagline">
              Creamos landing pages y páginas web que convierten visitantes en
              clientes para negocios y emprendedores.
            </p>
              ...
              <li>
                <a href="tel:+51921590084" className="footer__contact-link">
                  <svg
                    ...
                    strokeLinecap="round"
                  >
                    <path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.68 19.79 19.79 0 01.06 5.06 2 2 0 012 2.87h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L6.09 10.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 16.92z" />
                  </svg>
                  Llamar al equipo
                </a>
              </li>
        ...
        <div className="footer__bottom">
          <p>
            © {new Date().getFullYear()} FLANOVAX. Todos los derechos
            reservados.
          </p>
